  ...
  Future<void> initSound() async {
    ...
    sounds = [
      SoundModels(
        ...
        soundPath: 'assets/sounds/stream/stream_20kHz.flac',
      ...
      SoundModels(
        ...
        soundPath: 'assets/sounds/stream/stream_30kHz.flac',
      ...
      SoundModels(
        ...
        soundPath: 'assets/sounds/stream/stream_42kHz.flac',
      ...
      SoundModels(
        ...
        soundPath: 'assets/sounds/rain/rain_20kHz.flac',
        frequency: FrequencyEnum.frequency20kHz.title,
      ),
      SoundModels(
        soundId: 5,
        ...
        soundPath: 'assets/sounds/rain/rain_30kHz.flac',
        frequency: FrequencyEnum.frequency30kHz.title,
      ),
      SoundModels(
        soundId: 6,
        ...
        soundPath: 'assets/sounds/rain/rain_42kHz.flac',
        frequency: FrequencyEnum.frequency42kHz.title,
      ),
    ];
